...
quotes = [
    ...
    "I think so, Brain, and um, Larry, but how can we get 7 dwarves to shave their legs? - Pinky & The Brain... and Larry",
...
@router.get("/aypwip")
def aypwip():
    return {"quote": quotes[randint(0, 177)]}
